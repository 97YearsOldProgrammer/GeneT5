#!/bin/bash
#
# ProteinQC per-project container
#
# Usage: bash init/gpu/start-pqc.sh [--fresh]
...
docker run --gpus all -it \
    ...
    --privileged \
    --ulimit memlock=-1:-1 \
    -v /home/cg666/Code/ProteinQC:/workspace/code \
    -v /home/cg666/Data/ProteinQC:/workspace/data \
