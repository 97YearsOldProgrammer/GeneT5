...
class FlashAttention(nn.Module):
    """Hopper-optimized FA3 attention with optional FP8 and native GQA packing"""
    ...
    def forward(self, hidden_states, cu_seqlens=None, max_seqlen=None):
        """Bidirectional FA3 attention with optional varlen packed mode"""
        ...
        # FA3 native GQA packing (no manual KV head expansion needed)
        pack_gqa = self.num_heads != self.num_kv_heads
        ...
        if cu_seqlens is not None:
            ...
            # FA3 returns (out, softmax_lse) tuple
